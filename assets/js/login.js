...
const L = window.LANG || {
  ...
  submitText: 'تسجيل الدخول', submittingText: 'جاري تسجيل الدخول...',
  toastFill: 'راجع البيانات أولاً',
  toastSuccess: '✅ تم تسجيل الدخول بنجاح، جاري التحويل...',
  toastError: 'حدث خطأ، حاول مرة أخرى',
  toastConnError: 'خطأ في الاتصال بالخادم، حاول مرة أخرى'
};
...
togglePass.addEventListener('click', () => {
  ...
  togglePass.textContent = hidden ? L.hideText : L.showText;
});
